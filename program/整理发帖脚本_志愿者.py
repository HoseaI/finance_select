...
def write_file(content):
    with open(root_path + '/program/发帖脚本/发帖文件_志愿者.md', 'w', encoding='utf8') as f:
        f.write(content)
...
with open(root_path + '/program/发帖脚本/发帖模板_志愿者.md', 'r', encoding='utf8') as file:
    template = file.read()
    template = template % (rtn_str, year_rtn_str)
    print(template)
    write_file(template)
